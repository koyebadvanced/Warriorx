...
photologo = 'https://i.postimg.cc/zBWXd78H/IMG-20250526-113151-476.jpg'  # Optional alt: https://envs.sh/GV0.jpg
photoyt   = 'https://i.postimg.cc/zBWXd78H/IMG-20250526-113151-476.jpg'
photocp   = 'https://i.postimg.cc/JtC1yjLj/IMG-20250529-123730-492.jpg'

# Inline keyboard for start command
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/staystrongbros")]])
keyboard = InlineKeyboardMarkup(
    [
        [InlineKeyboardButton(text="💎 Help", url="https://t.me/staystrongbros"), InlineKeyboardButton(text="🧣 Developer", url="https://t.me/staystrongbros")],
    ]
)
...
async def start(bot, m: Message):
    ...
    caption = f"🌟 𝐖𝐞𝐥𝐜𝐨𝐦𝐞 {m.from_user.mention} ⚡⚡"

    start_message = await bot.send_photo(
        chat_id=m.chat.id,
        photo="https://i.postimg.cc/vBHYKVyx/wallhaven-2k73wm.jpg",
        caption=caption
    )
...
async def help_button(client, callback_query):
  ...
  caption = (
    ...
    "🧩 𝐁𝐚𝐬𝐢𝐜 𝐂𝐨𝐦𝐦𝐚𝐧𝐝𝐬:\n\n"    
    "• /start — 𝐁𝐨𝐭 𝐒𝐭𝐚𝐭𝐮𝐬 𝐂𝐡𝐞𝐜𝐤\n"    
    "• /drm — 𝐄𝐱𝐭𝐫𝐚𝐜𝐭 𝐟𝐫𝐨𝐦 .𝐭𝐱𝐭 (𝐀𝐮𝐭𝐨)\n"    
    "• /stop — 𝐂𝐚𝐧𝐜𝐞𝐥 𝐑𝐮𝐧𝐧𝐢𝐧𝐠 𝐓𝐚𝐬𝐤\n\n"    

    "🏝 𝐕𝐢𝐝𝐞𝐨 𝐓𝐨𝐨𝐥𝐬:\n\n"    
    "• /y2t — 𝐘𝐓 𝐓𝐨 𝐓𝐞𝐱𝐭 𝐂𝐨𝐧𝐯𝐞𝐫𝐭𝐞𝐫\n"    
    "• /ytm — .𝐭𝐱𝐭 𝐓𝐨 .𝐦𝐩𝟑 𝐃𝐨𝐰𝐧𝐥𝐨𝐚𝐝𝐞𝐫\n"    
    "• /yt2m — 𝐘𝐓 𝐋𝐢𝐧𝐤 𝐓𝐨 .𝐦𝐩𝟑\n"    
    "• /t2t — 𝐓𝐞𝐱𝐭 𝐓𝐨 .𝐭𝐱𝐭 𝐆𝐞𝐧𝐞𝐫𝐚𝐭𝐨𝐫\n"    
    "• /cookies — 𝐔𝐩𝐝𝐚𝐭𝐞 𝐂𝐨𝐨𝐤𝐢𝐞𝐬\n\n"    

    "🎄 𝐔𝐬𝐞𝐫 𝐓𝐨𝐨𝐥𝐬:\n\n"    
    "• /id — 𝐘𝐨𝐮𝐫 𝐂𝐡𝐚𝐭 / 𝐔𝐬𝐞𝐫 𝐈𝐃\n"    
    "• /info — 𝐔𝐬𝐞𝐫 𝐃𝐞𝐭𝐚𝐢𝐥𝐬\n"    
    "• /logs — 𝐕𝐢𝐞𝐰 𝐁𝐨𝐭 𝐋𝐨𝐠𝐬\n\n"

    "╭━━━━━━━━━━━━━━━━━━━━╮\n"
    "   🔧 𝐌𝐚𝐝𝐞 𝐛𝐲: [𝐖𝐀𝐑𝐑𝐈𝐎𝐑](https://t.me/staystrongbros)\n"
    "╰━━━━━━━━━━━━━━━━━━━━╯"
)
...
async def help_button(client, callback_query):
  ...
  await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://i.postimg.cc/tCLWFsBz/wallhaven-pke5qj.png",
      caption=caption
    ),
    reply_markup=keyboard
  )
...
async def upgrade_button(client, callback_query):
    ...
    caption = (
    "🛸 ⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆ 🛸\n"
    "     𝐖𝐀𝐑𝐑𝐈𝐎𝐑 𝐅𝐄𝐀𝐓𝐔𝐑𝐄𝐒 𝐔𝐍𝐋𝐎𝐂𝐊𝐄𝐃\n"
    "🛸 ⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆⋆ 🛸\n\n"

    f"🌟 𝐖𝐞𝐥𝐜𝐨𝐦𝐞 [𝐖𝐚𝐫𝐫𝐢𝐨𝐫](tg://user?id={user_id}) ⚡\n\n"

    "💠 𝐘𝐨𝐮 𝐜𝐚𝐧 𝐧𝐨𝐰 𝐚𝐜𝐜𝐞𝐬𝐬 𝐭𝐡𝐞 𝐟𝐨𝐥𝐥𝐨𝐰𝐢𝐧𝐠:\n\n"

    "📦  𝐀𝐏𝐏𝐗 𝐙𝐢𝐩 + 𝐄𝐧𝐜𝐫𝐲𝐩𝐭𝐞𝐝 𝐔𝐑𝐋𝐬\n"
    "🛡️  𝐂𝐥𝐚𝐬𝐬𝐩𝐥𝐮𝐬 𝐃𝐑𝐌 / 𝐍𝐃𝐑𝐌\n"
    "👨‍🏫  𝐏𝐡𝐲𝐬𝐢𝐜𝐬𝐖𝐚𝐥𝐥𝐚𝐡 𝐃𝐑𝐌\n"
    "📘  𝐂𝐚𝐫𝐞𝐞𝐫𝐖𝐢𝐥𝐥 𝐏𝐃𝐅𝐬\n"
    "📗  𝐊𝐡𝐚𝐧 𝐆𝐥𝐨𝐛𝐚𝐥 𝐒𝐭𝐮𝐝𝐢𝐞𝐬\n"
    "🎓  𝐒𝐭𝐮𝐝𝐲𝐈𝐐\n"
    ...
    "🔬  𝐕𝐞𝐝𝐚𝐧𝐭𝐮\n"
    "🏫  𝐀𝐝𝐝𝐚𝟐𝟒𝟕\n"
    "🚀  𝐀𝐏𝐏𝐗 + 𝐃𝐑𝐌 𝐏𝐃𝐅 𝐔𝐧𝐥𝐨𝐜𝐤𝐬\n"
    "💻  𝐁𝐫𝐢𝐠𝐡𝐭𝐜𝐨𝐯𝐞 / 𝐕𝐢𝐦𝐞𝐨\n"
    "📝  𝐙𝐨𝐨𝐦 𝐕𝐢𝐝𝐞𝐨 𝐑𝐞𝐜𝐨𝐫𝐝𝐬\n"
    "🎓  𝐔𝐭𝐤𝐚𝐫𝐬𝐡 (𝐕𝐢𝐝𝐞𝐨 + 𝐏𝐃𝐅)\n"
    "🧩  𝐌𝐏𝐃 𝐔𝐑𝐋𝐬 (𝐰𝐢𝐭𝐡 𝐤𝐞𝐲)\n\n"

    "💎 𝐌𝐨𝐧𝐭𝐡𝐥𝐲 𝐏𝐥𝐚𝐧: <b>𝐅𝐑𝐄𝐄</b>\n\n"
    f"📞 𝐅𝐨𝐫 𝐩𝐫𝐞𝐦𝐢𝐮𝐦 𝐬𝐮𝐩𝐩𝐨𝐫𝐭, 𝐜𝐨𝐧𝐭𝐚𝐜𝐭 [{CREDIT}](tg://user?id={OWNER})"
)
...
async def feature_button(client, callback_query):
  ...
  keyboard = InlineKeyboardMarkup([
      ...
      [InlineKeyboardButton("💧 Watermark", callback_data="watermark_command"), InlineKeyboardButton("♻️ Resat", callback_data="resat_command")],
      [InlineKeyboardButton("🖨️ Bot Working Logs", callback_data="logs_command")],
      [InlineKeyboardButton("🗂️ File Name", callback_data="custom_command"), InlineKeyboardButton("📂 Title", callback_data="titlle_command")],
  ...
  await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://i.postimg.cc/k49kGXrJ/wallhaven-57xoy7.png",
      caption=caption
    ),
    reply_markup=keyboard
  )
...
async def pin_button(client, callback_query):
  ...
  await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://i.postimg.cc/RVq2NDYH/wallhaven-r7kz7m.png",
      caption=caption
      ),
      reply_markup=keyboard
  )
...
async def watermark_button(client, callback_query):
  ...
  await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://i.postimg.cc/vHf9GQv2/wallhaven-nzyyey.jpg",
      caption=caption
      ),
      reply_markup=keyboard
  )
...
async def restart_button(client, callback_query):
  ...
  await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://i.postimg.cc/yd0BkrrK/wallhaven-p2qx8p.png",
      caption=caption
      ),
      reply_markup=keyboard
  )
...
async def pin_button(client, callback_query):
  ...
  await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://i.postimg.cc/Wzf9js61/wallhaven-dgpx9m.jpg",
      caption=caption
      ),
      reply_markup=keyboard
    )
...
async def custom_button(client, callback_query):
  ...
  await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://i.postimg.cc/wxt4cm6t/wallhaven-p85rw3.jpg",
      caption=caption
      ),
      reply_markup=keyboard
  )
...
async def editor_button(client, callback_query):
  ...
  await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://i.postimg.cc/2S31Vrdf/wallhaven-rq2yxm.jpg",
      caption=caption
      ),
      reply_markup=keyboard
  )
